      ...
      <div className="problemset-right">
        ...
        <Paper className={classes.root}>
          <TableContainer className={classes.container}>
            <Table stickyHeader aria-label="sticky table" style={{ borderSpacing: '0 8px'}}>
              <TableHead>
                <TableRow>
                  {columns.map((column) => (
                    <TableCell
                      key={column.id}
                      align={column.align}
                      style={{ minWidth: column.minWidth, backgroundColor:"black", color:"whitesmoke"}}
                    >
                      {column.label}
                    </TableCell>
                  ))}
                  ...
                  .map((row, index) => {
                    return (
                      ...
                      <TableRow
                        ...
                        role="checkbox"
                        tabIndex={-1}
                        style={{ backgroundColor: "#022863", color: "white", borderRadius: '15px' }}
                        key={index}
                      >
                        {columns.map((column) => {
                          const value =
